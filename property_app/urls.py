...
from .views import PropertyView, PropertyDetailView,AgentProperty,PropertySearchView,FullDetails,RetrievePropertyimage,GetPropertyImage
urlpatterns=[
    ...
    path('images/<int:pk>/',RetrievePropertyimage.as_view(),name="property_images"),
